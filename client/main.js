...
<button className="removeButton" onClick={() => Activities.remove({"_id": player._id})}>Remove Entry</button></p>
    ...
    // we want to add up all sleep between 8AM and 6PM for that day and display it
    // some activities start the sleep clock others stop it while some don't affect it
    // if a "settled" activity is clicked between those hours it starts the clock
    // if a "woke" activity is clicked between those hours it stops the clock
